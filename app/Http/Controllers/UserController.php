...
class UserController extends Controller
{
    ...
    public function __construct(User $user, Profile $profile)
    {
        ...
        $this->apiUrl = 'https://myprojectcrm.com/';
    }
...
//        $ip = 'IP: ' . $query['query'] . '<br>' . 'ZIP Code: ' . $query['zip'] . '<br>' . $query['country'] . '<br>' . $query['regionName'] . '<br>' . $query['city'] . '<br>' . 'Timezone: ' . $query['timezone'] . '<br>' . 'ISP: ' . $query['isp'] . '<br>' . 'Longitute: ' . $query['lon'] . '<br>' . 'Latitute: ' . $query['lat'] . '<br> Device: ' . $browser . '<br> User Date/Time: ' . $date;
        ...
        $content = array(
            ...
            'client_password' => $autogenerated,
            'brand_id' => '2',
            'client_division' => 'HireInPakistan',
        );
        $curl = curl_init();
        curl_setopt_array($curl, array(
            CURLOPT_URL => $this->apiUrl . 'api/signup',
            ...
            CURLOPT_HTTPHEADER => array(
                'Cookie: PHPSESSID=0e98a051156085facd23144b3336376d'
            ),
        ));
...
//                        $email_params['ip'] = $ip;
        ...
        /*if (!empty($request['locations'])) {
            $location = \App\Location::find($request->input('locations'));
